    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details (string stripeToken)
        {
            OrderHeader orderHeader =
                _unitOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == OrderVM.OrderHeader.Id, includeProperties: "ApplicationUser");
            if (stripeToken != null)
            {
        ...
        public IActionResult StartProcessing(int id)
        {
            ...
            orderHeader.OrderStatus = SD.StatueInProcess;
            _unitOfWork.Save();
        ...
        {
            var claimsIdentuty = (ClaimsIdentity)User.Identity;
            var claim = claimsIdentuty.FindFirst(ClaimTypes.NameIdentifier);
            ...
            switch (status)
            {
                ...
                case "inprocess":
                    orderHeaderList = orderHeaderList.Where(o => o.OrderStatus == SD.StatusApproved || 
                                                            o.OrderStatus == SD.StatueInProcess || 
